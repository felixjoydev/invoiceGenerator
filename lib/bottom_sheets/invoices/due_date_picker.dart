...
class DueDatePickerSheet extends StatefulWidget {
  final Function(DateTime?)? onDateSelected;
  final DateTime? initialDate;

  const DueDatePickerSheet({super.key, this.onDateSelected, this.initialDate});

  @override
  State<DueDatePickerSheet> createState() => _DueDatePickerSheetState();
}

class _DueDatePickerSheetState extends State<DueDatePickerSheet> {
...
/// Helper method to show the DueDatePickerSheet as a modal bottom sheet
