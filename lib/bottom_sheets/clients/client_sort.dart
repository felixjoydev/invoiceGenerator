                ...
                Column(
                  children: [
                    ...
                    SortOption(
                      ...
                      onTap: () {
                        setState(() {
                          _selectedOption = _selectedOption == 4 ? null : 4;
                        });
                      },
                    ),
                    SizedBox(height: 16),
                    ...
                    // Option 6
                    SortOption(
                      title: 'Client Name (Ascending)',
                      isSelected: _selectedOption == 5,
                      onTap: () {
                        setState(() {
                          _selectedOption = _selectedOption == 5 ? null : 5;
                        });
                      },
                    ),
                    SizedBox(height: 16),
                    ...
                    // Option 7
                    SortOption(
                      title: 'Client Name (Descending)',
                      isSelected: _selectedOption == 6,
                      onTap: () {
                        setState(() {
                          _selectedOption = _selectedOption == 6 ? null : 6;
                        });
                      },
                    ),
                  ],
